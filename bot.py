...
async def start(update: Update, context):
    ...
    await update.message.reply_text(f"Hi {user.first_name}! Send me a NFCe URL to scrape.")
...
async def scrape_nfce(update: Update, context):
    ...
    try:
        ...
        summary = f"Invoice scraped successfully!\n\n" \
        ...
        await update.message.reply_text("An error occurred while scraping the NFCe. Please try again later.")
...
def main():
    ...
    application.add_handler(MessageHandler(filters.TEXT & ~filters.COMMAND, scrape_nfce))
